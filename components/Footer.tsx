...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-white/10 bg-[#0E0E10] pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-10 mb-20">
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="text-gray-500 text-sm leading-relaxed">
            The AI-first operating system for modern real estate agencies.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-500">
            ...
            <li><a href="#" className="hover:text-white transition-colors">CRM Sync</a></li>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-gray-600 text-sm">© 2024 Propel AI Inc. All rights reserved.</p>
